...
final class LCSS {
     ...
     */
    static int[] bestSubsequence(String completion, String token) {
        int bestScore = -1;
    ...
    static int scoreSubsequence(int[] s1) {
        int score = 0;
    ...
    static List<int[]> findSequences(String completion, String token) {
        return new SequenceFinder(completion, token).findSeqeuences();
    }

    static boolean containsSubsequence(String completion, String token) {
