...
public interface Cache {
    ...
    /**
     * Factory methods for some basic {@link Cache} implementations.
     */
    class Caches {
         ...
         * {@link EditorConfigLoader#load(Resource)} on each invocation of
         * {@link Cache#get(Resource, EditorConfigLoader)}. Because it keeps no state, the instance can be safely
         * accessed from concurrent threads.
         *
