...
/**
 * An occurrence of syntax error or other error in an {@code .editorconfig} file.
 *
 * @author <a href="https://github.com/ppalaga">Peter Palaga</a>
 */
public class ErrorEvent extends Span {
    ...
    public enum ErrorType {
         ...
         * without value, or property name not followed by equal sign. Non-syntax errors that may happen with the
         * current implementation are only of two kinds: (i) broken {@link Glob} pattern or (ii) invalid value for the
         * given registered {@link PropertyType}.
         *
    ...
    /**
     * {@link ErrorType} is a way to keep apart various kinds of errors in a type safe way.
     *
